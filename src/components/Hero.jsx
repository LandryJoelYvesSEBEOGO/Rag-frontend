...
import heroImage from '../assets/Fichier 1@3x.png'
      ...
      <div className="w-full md:w-1/2 space-y-8">
        <motion.div variants={fadeIn('right', 0.2)} initial="hidden" whileInView="show">
          ...
          <div className="flex items-center gap-2 bg-gray-50 w-fit px-4 py-2 rounded-full hover:bg-gray-100 transition-colors cursor-pointer group">
            ...
            <span className="text-sm font-medium">Context is everywhere</span>
          </div>
        </motion.div>
        ...
        >
          ...
          our AI delivers precise and contextual responses            <span className="absolute bottom-0 left-0 w-full h-0.5 bg-blue-200/60"></span>
          </span>{' '}
           to boost your productivity.          <span className="inline-block ml-2 animate-pulse">⏰</span>
        </motion.h1>
